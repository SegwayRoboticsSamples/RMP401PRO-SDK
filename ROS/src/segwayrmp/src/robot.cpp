...
void ros_set_iap_cmd_callback(const segway_msgs::ros_set_iap_cmdGoalConstPtr &ros_set_iap_cmd_goal, iapActionServer *as)
{
    switch (ros_set_iap_cmd_goal->board_index_for_iap)
    {
        ...
        case 2: 
            ...
            break;
        default: 
            ROS_INFO("ros_set_iap_cmd_goal->board_index_for_iap[%d] value out of the normal rande[0,1,2]", ros_set_iap_cmd_goal->board_index_for_iap);
            break;
    }
    ...
    while (!isHostIapOver())
    {
        ...
        {
            iap_fb.iap_percent = getIapProgress();
